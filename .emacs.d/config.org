...
* Prelude
  ...
  Another source of inspiration is the excelent documentation of a 
  emacs configuration available on [[https://github.com/alhassy/emacs.d][A Life Configuring Emacs]].
