...
#+begin_src emacs-lisp
  (defhydra hydra-global-sexp (:color blue)
    ...
    ("a" beginning-of-defun "Defun Beg" :color red)
    ("e" end-of-defun  "Defun End" :color red)
    ...
    ("<delete>" kill-sexp "Kill>" :color red)
...
*** Rust
** Rust
*** rust-mode toml-mode cargo and flycheck
...
#+begin_src emacs-lisp
  ...
  (setq bib-files-directory '(directory-files
                              ...
                              "^[A-Z|a-z].+.bib$"))
  (setq pdf-files-directory '(concat (getenv "HOME") "/Dropbox/pdf/"))
#+end_src
